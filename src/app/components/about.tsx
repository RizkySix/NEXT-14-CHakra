    ...
    return (
          ...
          <div className="lg:clearfix">
            <div className="house-img lg:float-left lg:w-1/2">
                <img data-aos="fade-up-right" src="/house.jpg" alt="hero-img" className="lg:h-screen h-auto w-full object-cover" />
            </div>
            ...
            <div  className="about-text lg:float-right mt-11 lg:mt-[20%] lg:w-2/6 lg:px-0 px-6 flex flex-col gap-4 justify-center">
                ...
                <img data-aos="fade-up-left" src="/neckles.jpg" alt="hero-img" className="w-full h-[400px] lg:h-[700px] object-cover" />
