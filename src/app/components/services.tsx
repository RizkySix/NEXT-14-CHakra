    ...
    return (
        <>
          ...
          <div className="lg:clearfix">
            ...
            >
                <GridItem colSpan={4}>
                <img data-aos="flip-right" src="/serv-1.jpg" alt="serv-img" className="w-full h-[200px] lg:h-full object-cover" />
                
                </GridItem>
                <GridItem colSpan={3}>
                    <img data-aos="flip-right" src="/serv-2.jpg" alt="serv-img" className="w-full h-[200px] lg:h-full object-cover" />

                    {/* <FadeInImage src="/serv-2.jpg" alt="Service Image" className="w-full h-[200px] lg:h-full object-cover" /> */}
                   
                </GridItem>
                <GridItem colSpan={7}>
                    <img data-aos="flip-left" src="/serv-3.jpg" alt="serv-img" className="w-full h-full object-cover" />
